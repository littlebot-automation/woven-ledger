...
#[ORM\Entity(repositoryClass: PurchaseBillLineRepository::class)]
class PurchaseBillLine
{
    ...
    #[ORM\ManyToOne(targetEntity: PurchaseBill::class, inversedBy: 'lines')]
    ...
    public function setBill(?PurchaseBill $bill): static
    {
        $this->bill = $bill;
